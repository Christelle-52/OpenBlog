...
class __TwigTemplate_ebecfb01bee66f7bb548b8d5ea2fb4cb extends Template
{
    ...
    <p>Vous n'avez pas accès à cette zone</p>
    <p>Message : ";
        // line 8
    ...
    <p>Code : ";
        ...
        yield "</p>
    <p>Message de l'exception : ";
        // line 10
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 10, $this->source); })()), "message", [], "any", false, false, false, 10), "html", null, true);
        yield "</p>
</main>
";
    ...
    {
        return array (  113 => 10,  109 => 9,  105 => 8,  100 => 5,  87 => 4,  64 => 3,  41 => 1,);
    }
...
<main class=\"container\">
    ...
    <p>Code : {{ status_code }}</p>
    <p>Message de l'exception : {{ exception.message }}</p>
</main>
{% endblock %}", "@Twig/Exception/error403.html.twig", "/var/www/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
