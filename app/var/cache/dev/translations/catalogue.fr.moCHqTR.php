...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'Il y a déjà un compte avec ce pseudo' => '__Il y a déjà un compte avec ce pseudo',
    'Minimum {{ limit }} caractères' => '__Minimum {{ limit }} caractères',
    'Maximum {{ limit }} caractères' => '__Maximum {{ limit }} caractères',
    'L\'adresse email {{ value }} est incorrect' => '__L\'adresse email {{ value }} est incorrect',
  ),
  'security' => 
  array (
  ...
  'messages+intl-icu' => 
  array (
    'Category created succesfully' => 'Catégorie créée avec succès',
    'Home' => 'Accueil',
    'Posts' => 'Articles',
